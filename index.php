...
<body>
 <section class="homeSection">
  ...
  <!-- NavBar End
   ...
   <h1 class="siteName"><img src="images/slogo.png"></h1>
   ...
   <div class="container visible-xs">
       ...
       <h3>Stores</h3>
        ...
        <a href="edgars/edgars.php"><button type="button" class="btn btn-default activeTab">Store Name</button></a>
        <a href="jet/jet.php"><button type="button" class="btn btn-default activeTab">Store Name</button></a>
        <a href="#"><button type="button" class="btn btn-default activeTab">Store Name</button></a>
        <a href="#"><button type="button" class="btn btn-default activeTab">Store Name</button></a>
        <a href="#"><button type="button" class="btn btn-default activeTab">Store Name</button></a>
        <a href="#"><button type="button" class="btn btn-default activeTab">Store Name</button></a>
            ...
            <div class="panel-group category-products" id="accordian">
              <div class="panel panel-default activeTab sideTab">
                <div class="panel-heading">
                  <h4 class="panel-title"><a href="a/a.php">Store Name</a></h4>
                </div>
              </div>
              <div class="panel panel-default activeTab sideTab">
                <div class="panel-heading">
                  <h4 class="panel-title"><a href="b/b.php">Store Name</a></h4>
                </div>
              </div>
              <div class="panel panel-default activeTab sideTab">
                <div class="panel-heading">
                  <h4 class="panel-title"><a href="c/c.php">Store Name</a></h4>
                </div>
              </div>
              <div class="panel panel-default activeTab sideTab">
                <div class="panel-heading">
                  <h4 class="panel-title"><a href="#">Store Name</a></h4>
                </div>
              </div>
              <div class="panel panel-default activeTab sideTab">
                <div class="panel-heading">
          ...
          <!-- Indicators -->
            ...
            <div class="carousel-inner">
              <div class="item active">
                <img class="img-responsive" src="images/products/s5.png" alt="...">
                  <div class="carousel-caption">
                    <h3 class="pull-right" id="discount">At Store ....</h3>
                  </div>
              </div>
              <div class="item">
                ...
                <div class="item">
                  <img class="img-responsive" src="images/products/xbox.png" alt="...">
                    <div class="carousel-caption">
                      <h3 class="pull-right" id="discount">At Store ....</h3>
                  </div>
                </div>
                <div class="item">
                <img class="img-responsive" src="images/products/tv.png" alt="...">
                  <div class="carousel-caption">
                      <h3 class="pull-right" id="discount">At Store ....</h3>
                  </div>
                </div>
                <div class="item">
                <img class="img-responsive" src="images/products/ps4.png" alt="...">
                  <div class="carousel-caption">
                      <h3 class="pull-right" id="discount">At Store ....</h3>
                  </div>
                </div>
