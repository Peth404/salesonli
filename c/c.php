  ...
  <!-- tabs show on small screen -->
   <div class="container mobileMenu visible-xs">
      <h2>Stores</h2>
        ...
        <a href="jet.php"><button type="button" class="btn btn-default activeTab">Store Name</button></a>
            ...
            <div class="panel-group category-products" id="accordian">
              ...
              <div class="panel panel-default activeTab sideTab">
                <div class="panel-heading"  id="ed">
                  <h4 class="panel-title active"><a href="../a/a.php">Store Name</a></h4>
                </div>
              </div>
              <div class="panel panel-default activeTab sideTab">
                <div class="panel-heading"  id="ed">
              ...
              <div class="panel panel-default activeTab sideTab">
                <div class="panel-heading"  id="ed">
                  <h4 class="panel-title"><a href="c.php">Store Name</a></h4>
                </div>
              </div>
              <div class="panel panel-default activeTab sideTab">
                <div class="panel-heading"  id="ed">
